      ...
      >
        ...
        <SafeAreaView style={s.safe}>
          ...
          <View style={s.content}>
            ...
            <View style={s.card}>
              <Text style={s.title}>Sync Successful</Text>
              <Text style={s.subtitle}>
                Farm <Text style={s.bold}>{farmId}</Text> boundary has been uploaded to the Plotra cloud.
              </Text>
              ...
              <View style={s.statGrid}>
                ...
                <View style={s.statItem}>
                  ...
                  <Text style={[s.statVal, { color: C.syncedText }]}>Verified</Text>
                </View>
              </View>
              ...
              >
                <Text style={s.primaryBtnText}>Map Next Farm</Text>
              </TouchableOpacity>
              ...
              >
                <Text style={s.secondaryBtnText}>View Sync History</Text>
              </TouchableOpacity>
            </View>
          </View>
...
const s = StyleSheet.create({
  ...
  successCircle: { width: 90, height: 90, borderRadius: 45, backgroundColor: 'rgba(255,255,255,0.2)', alignItems: 'center', justifyContent: 'center', marginBottom: -45, zIndex: 10, borderWidth: 4, borderColor: C.white },
  checkBg: { width: 64, height: 64, borderRadius: 32, backgroundColor: '#22c55e', alignItems: 'center', justifyContent: 'center' },
  checkIcon: { color: C.white, fontSize: 32, fontWeight: '900' },
