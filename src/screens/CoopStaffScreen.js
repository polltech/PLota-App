...
const ROLE_META = {
  [ROLES.DELIVERY_AGENT]: {
    ...
    accessDesc: 'Deliveries tab only',
  },
  [ROLES.WASHING_STATION]: {
    color: '#0891b2', bg: '#e0f2fe',
    icon: 'water-outline',
    privileges: [
      'Manage all deliveries and receipts',
      'Create and process wet-mill batches',
      'Log sorting and washing processing steps',
      'View batch traceability data',
    ],
    accessDesc: 'Deliveries + Batches tabs',
  },
  [ROLES.POST_HARVEST]: {
    ...
    privileges: [
      ...
      'Mark batches ready for export',
      'View and annotate batch processing history',
    ],
    accessDesc: 'Lab Results + Batches tabs',
  },
  [ROLES.AGRONOMIST]: {
    color: '#15803d', bg: '#dcfce7',
    icon: 'leaf-outline',
    privileges: [
      'Validate farmer onboarding applications',
      'Review and approve farm data and GPS boundaries',
      'Assess compliance and EUDR documentation',
      'Request updates from farmers',
    ],
    accessDesc: 'Farmers + Farms tabs',
  },
  [ROLES.FINANCE_ADMIN]: {
    color: '#1d4ed8', bg: '#dbeafe',
    icon: 'briefcase-outline',
    privileges: [
      'Manage export consignments and documentation',
      'Process payment disbursements to farmers',
      'Generate financial reports and outturn summaries',
      'View batch and delivery financial data',
    ],
    accessDesc: 'Batches + Consignments tabs',
  },
};
